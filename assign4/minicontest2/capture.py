...
if __name__ == '__main__':
  ...
  for i in range(len(lst)):
    ...
    ###
    myWinRate.append(redWinRate)
    myLoseRate.append(redLoseRate)
  ...
  ###
  print("My Win Rate: ", sum(myWinRate) / len(myWinRate))
  print("Opponents Win Rate: ", sum(myLoseRate) / len(myLoseRate))
  print("Draw Rate: ", 1 - sum(myWinRate) / len(myWinRate) - sum(myLoseRate) / len(myLoseRate))